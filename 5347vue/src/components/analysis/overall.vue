<template>
  <div>
    <el-row :span="24">
      ...
      <el-col :span="9">
        <el-table :data="mostReslist" stripe border>
          <el-table-column prop="_id" label="revise most title">
          </el-table-column>
          <el-table-column prop="totalRes" label="number">
          </el-table-column>
        </el-table>
      </el-col>
      <el-col :span="10">
        <el-table :data="leastReslist" stripe border>
          <el-table-column prop="_id" width="250px" label="revise least title">
          </el-table-column>
          <el-table-column prop="totalRes" label="number">
          </el-table-column>
        </el-table>
    ...
    <el-row :span="24">
      <el-col :span="8">
        <el-tag>shortest history</el-tag>
        <span>{{history2}}</span>
      </el-col>
      <el-col :span="12">
    ...
    <el-row>
      <el-carousel height="450px" indicator-position="outside" :autoplay=false>
        <el-carousel-item>
          <ve-histogram :data=this.chartData width="900px"></ve-histogram>
        </el-carousel-item>
        <el-carousel-item>
          <ve-pie :data=this.piechartData width="900px"></ve-pie>
        </el-carousel-item>
      </el-carousel>
    </el-row>
