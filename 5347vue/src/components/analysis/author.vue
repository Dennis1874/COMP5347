<template>
  <div>
    <el-row>
      <el-select v-model="author" :remote-method="authorRemoteMethod" :loading="selectAuthor.loading" filterable remote placeholder="please enter name">
    ...
    <el-row>
      <el-col :span="12">
        <el-table :data="revisionList" width="100%" max-height="400" stripe border>
          <el-table-column prop="_id" label="article name" width="230px">
          </el-table-column>
          <el-table-column label="timestamps">
            <template slot-scope="scope">
              <el-dropdown>
                <span class="el-dropdown-link">hover to show timestamp
