    ...
    <el-row>
      <el-col :span="16" style="margin-left:30px; margin-right:30px">
        <el-collapse accordion>
          ...
          <el-collapse-item title="Author Analytics" name="3">
            <div>show revisions made by an author</div>
          </el-collapse-item>
        </el-collapse>
        <br>
        <figure>
          <figcaption>a example of chart</figcaption>
          <img src="../assets/overall.png" alt="bar chart about revisions every year" class="example" />
        </figure>
      </el-col>
      <el-col :span="6">
